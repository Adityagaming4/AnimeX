  ...
  return (
    <>
      <div className="relative container mx-auto px-4 md:px-6 py-8">
        {anime.trailerId && (
          <div className="absolute inset-0 w-full h-[450px] overflow-hidden rounded-lg">
            <iframe
              src={`https://www.youtube.com/embed/${anime.trailerId}?autoplay=1&mute=1&controls=0&loop=1&playlist=${anime.trailerId}`}
